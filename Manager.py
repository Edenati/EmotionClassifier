...
lips_weights = {1: 22, 5: 2}
eyes_weights = {0: 2, 4: 5}
...
def run(path_to_video, seconds):
    manager = Manager("/Users/netanel.ossi/PycharmProjects/pythonProject/model-68.h5",
                      "/Users/netanel.ossi/PycharmProjects/pythonProject/saved_models/130000_100_48_5/model-15.h5")
